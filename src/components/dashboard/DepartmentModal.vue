    ...
    >
      ...
      <div class="p-4 border-b border-gray-200 dark:border-gray-700">
        <input
          v-model="searchQuery"
          type="text"
          placeholder="Введите подразделение для поиска"
          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray text-black dark:text-white focus:outline-none focus:ring-2 focus:ring-yellow"
        />
      </div>
